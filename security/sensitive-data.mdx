...
| Whisper Large V3 Turbo (Local) | Fast | High | Best balance of speed and quality for most use cases |
...
<Tip>
For sensitive environments, **Whisper Large V3 Turbo** is the recommended starting point. It offers high accuracy while being fast enough for clinical or professional workflows.
</Tip>
...
[History Management](../get-started/history)
