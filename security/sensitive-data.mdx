...
<CardGroup cols={2}>
<Card title="Enterprise Model Management" icon="server" href="../enterprise/models">
...
<CardGroup cols={2}>
<Card title="Model Management" icon="sliders" href="../enterprise/models">
Restrict cloud models and add approved custom models
</Card>
<Card title="SAML SSO" icon="lock" href="../enterprise/saml_sso">
...
| Healthcare / Finance | Nova Medical (Cloud), sign Superwhisper [BAA](https://trust.mycroft.io/superwhisper) | Claude 4.5 Sonnet (Anthropic, Cloud), sign Superwhisper [BAA](https://trust.mycroft.io/superwhisper) or Bring Your Own Keys | Covered by Superwhisper's zero-data-retention API terms or external provider agreement |
