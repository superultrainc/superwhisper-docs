...
| Healthcare / Finance | Nova Medical (Cloud) — sign Superwhisper [BAA](https://trust.mycroft.io/superwhisper) | Anthropic (Cloud) — sign Superwhisper [BAA](https://trust.mycroft.io/superwhisper) or Bring Your Own Keys | Covered by Superwhisper's zero-data-retention API terms or external provider agreement |
