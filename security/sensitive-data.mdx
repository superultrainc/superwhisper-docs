...
| Healthcare / Finance | Ultra V3 Turbo (Local) | Sign Superwhisper [DPA/BAA](https://trust.mycroft.io/superwhisper) and use Nova Medical or Anthropic (Cloud) — or Bring Your Own Keys | Covered by Superwhisper's zero-data-retention API terms or external provider agreement |
