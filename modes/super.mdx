...
---
<Tip>Super Mode focuses on context-aware dictation and formatting. For other kinds of commands with the same context features, use a [Custom Mode](custom).</Tip>