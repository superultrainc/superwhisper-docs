...
<Note>
When Application Context is active, Superwhisper also includes system information, like the current date and time, your full name, and your computer name. This can help the AI handle things like inserting in the date, signing off an email with your name, etc. Sending these details makes dictation results more accurate and lets the AI handle context-specific requests more smoothly.
</Note>
