...
Check the History tab to see if context was properly sent to AI. This can help you identify whether issues stem from system-level context capture or AI interpretation processing
</Accordion>
</AccordionGroup>

<br/>
<Note>**Super Mode focuses on context-aware dictation and formatting.** If you need a different type of command with similar smart features, check out Custom Mode.</Note>