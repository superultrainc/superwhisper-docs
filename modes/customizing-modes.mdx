...
src="Superwhisper history tab interface showing how to access original mode instructions for customization"
/>

</Step>

<Step title="Extract What You Need">
1. Find the `<instructions>` XML tags
2. Copy only the content between these tags
3. If present, note any `<examples>` sections
</Step>

<Step title="Create Your Custom Version">
1. Create a new Custom Mode
2. Click "Change Prompt"
3. Paste the copied instructions
4. Add any examples from the original mode
