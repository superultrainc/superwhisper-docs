...
## Additional settings
### AI instructions
Beyond selecting an AI model, Custom Mode lets you write your own AI processing instructions.
...
/>
With a Custom Mode selected, the Advanced Settings sidebar shows three context toggles:
- Application context
- Copied text
- Selected text
