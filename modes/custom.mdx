---
title: "Custom"
description: "Custom Mode runs your own AI instructions on your dictation. Combine them with context awareness to build specialized workflows."
---

<img
style={{ borderRadius: '0.5rem' }}
src="/images/screens/mac/modes-editor-custom.png"
...
- Full control over the AI processing instructions
- Context awareness
...
## Additional settings
### Custom instructions
The mode editor has a **Custom instructions** field. Describe the transformation you want in natural language; the AI applies it to every dictation in this mode.

<Note>Instructions are empty by default. If left blank, the AI doesn't know what task to perform and may give unexpected results.</Note>

### Context awareness
The **Context** row in the editor has three checkboxes:

<img
style={{ borderRadius: '0.5rem' }}
src="/images/screens/mac/modes-editor-custom-context.png"
alt="Superwhisper Custom Mode editor with the Selected text context enabled"
/>
...
<Note>These toggles work identically to [Super Mode context awareness features](/modes/built-in#context-awareness).</Note>
...
<Note>Adjust and expand your XML tags to fit your needs. More detailed instructions usually give better results.</Note>
</Accordion>
...
---
<Tip>Unlike other modes, Custom Mode isn't limited to text formatting. Combine context awareness with your instructions to build specialized workflows.</Tip>