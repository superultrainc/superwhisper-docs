...
<Note>
The CLI is available on macOS. It reads the same local database as the app, so everything stays on your device.
</Note>
...
superwhisper history --since 2026-09-01 --mode Email
