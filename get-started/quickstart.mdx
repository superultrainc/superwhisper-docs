...
<Info>
For iPhone and iPad, see [Superwhisper on iOS](/get-started/ios). If your company provides Superwhisper, your admin sends an invite — install the app and sign in with your work email.
</Info>
