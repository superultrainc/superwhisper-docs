...
By default, Superwhisper saves all configuration files in the **~/superwhisper** folder in your home directory. If you prefer to store your Superwhisper files in a different location, you can do so from within the Advanced settings in the Configuration tab.
...
<Steps>
  <Step title="Locate Your Configuration Folder">
    Navigate to the ~/superwhisper folder on your system, or to your custom location if you've changed the default.
  </Step>
