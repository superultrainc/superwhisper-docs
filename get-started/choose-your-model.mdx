...
description: "Create your first Superwhisper mode and pick its models along the way. A Message mode works with cloud or local models."
---
  ...
  <Step title="Pick your models">
    ...
    <Tabs>
      ...
      <Tab title="Local">
        ...
        <Note>Local language models are macOS-only for now. On Windows, pair Cohere Transcribe with a cloud language model, or use a Voice to Text mode with no AI processing.</Note>
...
**Standard, Nano, and Fast are free.** They are small and a good fit for quick notes.
