...
Superwhisper keeps configuration files in the ~/superwhisper folder in your home directory by default (older installs may still use ~/Documents/superwhisper). This folder stores your history files, your custom modes settings, vocabulary, and text replacements. **Creating a backup of this folder is recommended if you want to preserve your personalized configurations or transfer them to a new machine.**
