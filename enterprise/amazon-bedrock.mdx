...
<Note>
Replace `<region>` in the API URL with your AWS region (for example, `us-east-1` or `eu-west-1`). Model availability varies by region. Check the [Amazon Bedrock documentation](https://docs.aws.amazon.com/bedrock/latest/userguide/models-regions.html) to confirm your chosen model is available in yours.
</Note>
