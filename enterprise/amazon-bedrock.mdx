...
- Model access granted for at least one foundation model in your chosen region (managed in the [AWS Bedrock console](https://console.aws.amazon.com/bedrock/home#/modelaccess))
