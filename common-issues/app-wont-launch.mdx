...
2. Re-download from [superwhisper.com](https://superwhisper.com) and drag the app into **Applications** again. Replacing the old copy is safe: your settings live in the [Superwhisper folder](/get-started/settings-advanced#folder-location), not the app bundle
