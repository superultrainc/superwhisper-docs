...
Apple's iOS 26.4 update changed how third-party keyboards work. A behavior Superwhisper previously relied on is no longer available:

- **No automatic app return**: after tapping the Superwhisper keyboard button to start dictation, iOS no longer returns you to your previous app automatically. You now swipe back manually.

---

## How Superwhisper Adapts

All of Superwhisper's existing [modes](/modes/modes), including **Message**, **Email**, **Note**, and any custom modes you've created, continue to work as before. The only change is the extra swipe back after starting dictation.
