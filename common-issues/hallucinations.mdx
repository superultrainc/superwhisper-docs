...
<Tip>
Check the [History tab](../get-started/history) to identify exactly where hallucinations are occurring. You can analyze both the voice (transcription stage) and the AI-processed result to pinpoint the source of the issue.
</Tip>
