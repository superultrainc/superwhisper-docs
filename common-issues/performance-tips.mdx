...
<Steps>
  <Step title="Skip AI processing when you don't need it">
    Transcription and AI processing are separate steps. The [Voice to Text](/modes/voice) mode skips AI processing entirely and gives the fastest results when you don't need formatting.
  </Step>
