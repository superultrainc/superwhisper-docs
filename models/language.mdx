...
S1-mini runs entirely on your device (macOS only for now). Pair it with a local voice model and nothing you dictate leaves your machine. It also works offline.
