...
<Note>
Speed is a relative rating from 1 to 10. The Benchmark column is each model's published general-capability score, not a Superwhisper measurement; see [How We Benchmark](/models/benchmarks) for what we do measure ourselves.
</Note>
...
You can also add models from your own providers with your own API keys under **Settings → Models library → Bring your own keys**.
